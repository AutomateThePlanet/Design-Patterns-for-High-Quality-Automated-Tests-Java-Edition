...
public abstract class AssertableEShopPage<ElementsT extends BaseElements, AssertionsT extends BaseAssertions<ElementsT>> extends EShopPage<ElementsT> {
    public AssertableEShopPage(Driver driver) {
        super(driver);
    }
