...
public final class BenchmarkRunner_benchmarkJavaScriptClick_jmhTest {
    ...
    public BenchmarkTaskResult benchmarkJavaScriptClick_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                ...
                l_benchmarkrunner0_0.benchmarkJavaScriptClick(l_pluginstate1_3);
                l_benchmarkrunner0_0.tearDown(l_pluginstate1_2);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            benchmarkJavaScriptClick_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_pluginstate1_3, l_benchmarkrunner0_0, l_pluginstate1_1, l_pluginstate1_2);
    ...
    public BenchmarkTaskResult benchmarkJavaScriptClick_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            benchmarkJavaScriptClick_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_pluginstate1_3, l_benchmarkrunner0_0, l_pluginstate1_1, l_pluginstate1_2);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult benchmarkJavaScriptClick_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            benchmarkJavaScriptClick_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_pluginstate1_3, l_benchmarkrunner0_0, l_pluginstate1_1, l_pluginstate1_2);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult benchmarkJavaScriptClick_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            benchmarkJavaScriptClick_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_pluginstate1_3, l_benchmarkrunner0_0, l_pluginstate1_1, l_pluginstate1_2);
            control.preTearDown();
